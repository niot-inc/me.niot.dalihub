...
- **Fade Time Control** - Smooth transitions with 16 preset fade times (0.7s to 90.5s)
- **Scene Controller** - Recall DALI scenes by address, group, or broadcast with fade time support
...
- **Then (Actions)** - Set DALI level, brightness control, recall scenes - all with optional fade time for smooth transitions
